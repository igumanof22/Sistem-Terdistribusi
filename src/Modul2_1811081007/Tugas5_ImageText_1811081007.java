 ...
 * @author RyderPhantom
 */
public class Tugas5_ImageText_1811081007 {
    public static void main(String[] args) throws IOException {
        Image image_1007 = null;
        String lokasiImage = null;
        
        BufferedReader br_1007 = new BufferedReader(new FileReader("File_1811081007/ImageFile.txt"));
        String line_1007;
        
        while ((line_1007 = br_1007.readLine()) != null) {            
            lokasiImage = line_1007;
        }
        br_1007.close();
        ...
        frame_1007.pack();
        frame_1007.setTitle(lokasiImage);
